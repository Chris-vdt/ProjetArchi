		...
		public CatalogueCmdeClient loadClient(){
			//******************************** DESERIALISATION = r�cup�re le fichier sauvegard� ******************************************/
				...
				CatalogueCmdeClient catalogueCmde = new CatalogueCmdeClient();
					try {
						FileInputStream streamIn2 = new FileInputStream("/Users/Mavary/Documents/Serializer/monCatalogueCmdeClient.ser");   //On charge le fichier qui se trouve � l'espace indiqu�
