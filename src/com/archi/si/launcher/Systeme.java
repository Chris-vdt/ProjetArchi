	...
	public static void main(String[] args) throws IOException{
		...
		case 3: //creer un OF
			...
			if(isRefValid2 == true){
				...
				System.out.println("La reference existe déjà");
			}
			break;
		...
		case 6://Afficher les Of du catalogue d'OF
			...
			break;
			/*
		case 7://Plannifier OF -> Ajouter une date de d�but et de fin
			int refOf1 = poserQuestionInt("Quel est la r�f�rence de l'OF � plannifier" );
